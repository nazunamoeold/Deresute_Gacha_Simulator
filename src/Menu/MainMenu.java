...
interface userthing{
 ...
 class Menu extends JFrame implements userthing {
	...
	JTextArea skillstr = new JTextArea("½ºÅ³ : ");
	...
	JLabel skilltitle = new JLabel("½ºÅ³ ÀÌ¸§ : ");
	JLabel appealtitle = new JLabel("Æ¯ÈÆ Àü        Æ¯ÈÆ ÈÄ");
	...
	MainMenu(){
		...
		cardinfolist.addListSelectionListener(new ListSelectionListener(){
			public void valueChanged(ListSelectionEvent e) {
				...
				vocal.setText("º¸ÄÃ :     "+lists.unlimitedinfo().get(a).getvocal()+"            "+lists.unlimitedinfo().get(a).gettvocal());
				dance.setText("´í½º :     "+lists.unlimitedinfo().get(a).getdance()+"            "+lists.unlimitedinfo().get(a).gettdance());
				visual.setText("ºñÁê¾ó :   "+lists.unlimitedinfo().get(a).getvisual()+"            "+lists.unlimitedinfo().get(a).getvisual());
				skilltitle.setText("½ºÅ³ ÀÌ¸§ : "+lists.unlimitedinfo().get(a).getskilltitle());
				skillstr.setText("½ºÅ³ : "+lists.unlimitedinfo().get(a).getskillstr());
